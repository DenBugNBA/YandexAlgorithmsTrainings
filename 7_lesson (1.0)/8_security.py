...
# Wrong Answer
# Accepted
# tests = [(3, [0, 3000, 2500, 7000, 2700, 10000]), (2, [0, 3000, 2700, 10000])]

# Wrong Answer
# tests = [(3, [0, 5000, 3000, 4000, 4999, 10000])]

# Accepted
# Accepted
# tests = [(3, [0, 2, 1, 9999, 9999, 10000]), (3, [0, 3000, 2999, 7000, 6999, 10000])]

# Wrong Answer
# tests = [(3, [0, 5000, 3000, 5000, 5000, 10000])]

# Wrong Answer
# tests = [(3, [0, 5000, 0, 7000, 7000, 10000])]
